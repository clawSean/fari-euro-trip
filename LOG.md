...
2026-08-21T06:02:00Z · Sean · fix · Rewrote the site voice after JPop flagged the copy as "way too meta." Researched the current baddie/it-girl register (Perplexity, mid-2026 sources) and found the tone is deadpan and short in text while the maximalism lives in the visuals, and that writer-brain metaphors — plot, movie, chaos, production value, "that's a wrap" — read as describing the trip from outside rather than speaking from inside it. Replaced the hero headline with "Two friends. No notes.", the route heading with "Booked. Busy. Coast-bound.", the locked-drop line with "Unlocks on the day. No spoilers.", and the Cinque Terre framing with soft-life language. Recorded the register as a binding rule in `AGENTS.md` and a durable note at `knowledge/research/baddie-voice-register-2026-08-20.md`. Verified: `tsc` clean, 19/19 tests, production build, live bundle checks for both new and retired phrasing, zero horizontal overflow and zero console errors at 390px · AGENTS.md

2026-08-21T05:05:00Z · Sean · feat · Trip-start update. Locked the itinerary into a single source (`client/src/data/euro-itinerary.ts`) covering London Aug 19-22, Florence Aug 22-25, Amalfi Aug 25-27, Positano Aug 27-30, and Rome Aug 30-31; replaced the open coast decision with the final Amalfi/Positano split while keeping Cinque Terre visible as a deliberate pass; added a live trip-day "now" strip showing day counter, current city, next move, and today's drop; and extended the Spotlight runway from six pieces to fifteen through Aug 31, each unlocked drop now carrying a shot idea and a copyable caption starter plus a consent-first prompt for creator handles. Verified: `tsc` clean, 19/19 tests, production build, live bundle string checks for new and retired copy, zero horizontal overflow and zero console errors at 390px and 1440px · STATUS.md
